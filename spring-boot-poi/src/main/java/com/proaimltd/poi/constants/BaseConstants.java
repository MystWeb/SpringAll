...
package com.proaimltd.poi.constants;

/**
 * @project: proaim-trinity-demo
 * @packageName: com.proaimltd.web.common.enums
 * @author: liu10
...
public abstract class BaseConstants {
	...
	public static final String ALLOW_UPLOAD_EXCEL_FILE_MIME_TYPES = "application/vnd.ms-excel|application/zip|application/x-tika-ooxml";
